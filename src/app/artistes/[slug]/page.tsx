...
export default function page({ params }: Props) {
  const artistes = [
    ...
    },
    {
      ...
      description:
        "Anagramms est une artiste originaire d'Orléans. Enfant de la neo-soul, du RnB et des sonorités hop-hop, elle fait la fusion de ces genres pour créer une vibe très suave. \n\nC'est avec Gracy Hopkins qu'elle fait ses premiers pas dans la msique avec le titre 'Outside'. Son morceau 'fax' pose la première pierre à l'édifice puis s'en suivra le morceau 'J'essaie'. \n\nA chacune de ses performances, elle envoûte son public avec ses mélodies entêtantes et ses textes poignants. Grimpez dans le train Anagramms car ell en'a pas fini de vous charmer.",
      ...
      <div className="mt-[2rem] px-[1rem] lg:w-[70%] mx-auto lg:px-[10rem] ">
        {artist ? (
          <section className="flex flex-col justify-center items-center gap-[1rem] sm:gap-[2rem]">
            <div className="w-[80%] h-[80%] mx-auto sm:w-[60%] lg:w-[50%] ">
              <Image
            ...
            <div className="flex flex-col gap-[1rem] font-rubikLight text-justify sm:px-[3rem] lg:px-0">
