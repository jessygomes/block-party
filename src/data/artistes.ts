const artistes = [
  ...
  },
  {
    ...
    description:
      "Artiste complète et plurielle, Myra incarne parfaitement cette nouvelle génération de touche à-touche qui ne s’interdisent rien. Compositrice, chanteuse et actrice, elle crée son univers musical en 2020, véritable saudaded’aujourd’hui, entre délicatesse et incandescence. \n\nElle sortait au printemps 2024 son nouvel EP « Passion Câlins » axé autour de nombreuses collaborations : Myra fédère les artistes invités dans une ambiance chaleureuse et sensuelle pour un projet 100% featurings. \n\nPassion Câlins est un véritable hommage à l'amour et toutes ses facettes : du couple à la rupture, en passant par le premier date et tout ce qui se passe sous la couette, Myra invite chaque artiste à s’exprimer sur un sujet commun et dépeindre ces situations par lesquelles chacun d’entre nous est amené à passer.",
